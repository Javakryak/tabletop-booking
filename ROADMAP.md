...
- [~] Admin/privacy backend integration is partial: audit-log and emergency-contact flows are wired, while user block/unblock APIs are still needed to remove remaining admin fallback behavior.
